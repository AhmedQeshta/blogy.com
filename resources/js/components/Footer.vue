<template>
  <footer class="py-4">
    <div class="container text-center text-lg-left">
      <div
          class="row d-flex justify-content-between flex-column flex-lg-row align-items-center align-items-lg-start">
        <div class="d-flex flex-column col-10 col-lg-5 pl-0">
          <h5><a href="#">Pied Piper</a></h5>
          <p>Let's get you connected! We've designed a simple, efficient process for companies migrating to
            PiperNet. Here's how it works.</p>
          <ul class="list-inline d-flex mb-3 justify-content-center justify-content-lg-start">
            <li class="px-2"><a href="#"><img alt="" src="placeholder/icons/twitter.svg"></a></li>
            <li class="px-2"><a href="#"><img alt="" src="placeholder/icons/facebook-official.svg"></a></li>
            <li class="px-2"><a href="#"><img alt="" src="placeholder/icons/instagram.svg"></a></li>
          </ul>
        </div>
        <div>
          <h6>Products</h6>
      ...
      <div class="flex-column flex-sm-row align-items-center justify-content-sm-between">
        ...
        <p class="mb-0 small text-muted">© 2020 Pied Piper. All right reserved.</p>
      </div>
    </div>
  </footer>
</template>
